...
// var startString = "My name is: ";
// var devName = "Shoshard";
// alert(startString + devName);
...
// var newBal = userBal - 10;
// alert("You just lost $10!");
// alert("Your new balance is: $" + newBal);
...
// var uGrade = parseInt(prompt("Enter your grade."));
// var uExtra = parseInt(prompt("Enter your extra credit."));
// var finalGrade = uGrade + uExtra;
...
// alert("Your remaining balance is: $" + (balance - deduction));
